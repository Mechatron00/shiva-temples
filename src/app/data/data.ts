export const templesData = [
  {
    basic: {
      name: 'Murudeshwar',
      bio: "Murdeshwar is a town in Uttara Kannada district in the state of Karnataka, India, It is famous for the world's second tallest Shiva statue, the town lies on the coast of the Arabian Sea and is also famous for the Murudeshwara Temple. The town has a railway station on the Mangalore–Mumbai Konkan railway route.",
      location: {
        pin: 'Bhatkal',
        dist: 'Uttara Kannada',
        state: 'Karnataka',
        iframe:"https://www.mappls.com/7s513d",
      },
      coordinates: {
        x: 14.093617,
        y: 74.483825,
  ...
  contact:{
    ...
    gallery: [
      'https://upload.wikimedia.org/wikipedia/commons/3/3b/Murudeshwara_raja_gopura_HDR%2C_Jul_2012.jpg',
      'https://upload.wikimedia.org/wikipedia/commons/4/42/Lord_Shiva_the_tallest_statue_%40_Murudeswar.jpg',
      'https://upload.wikimedia.org/wikipedia/commons/4/4e/Tower_of_Murudeswar.jpg',
      'https://upload.wikimedia.org/wikipedia/commons/6/66/Murudeshwar_temple_from_beach.jpg',
      'https://upload.wikimedia.org/wikipedia/commons/4/4c/Murudeshwar_Full_view.jpg',
      'https://upload.wikimedia.org/wikipedia/commons/4/4f/Lord_Shiva_statue_at_Murudeshwara.jpg',
      'https://upload.wikimedia.org/wikipedia/commons/7/7a/Statue_of_Nandi_at_Murudeshwar_Temple.jpg',
      'https://upload.wikimedia.org/wikipedia/commons/4/43/Murudeshwara_Temple.JPG',
  ...
  },
  {
    basic: {
      name: 'Brihadisvara',
      bio: "Brihadishvara Temple, called Rajarajesvaram ('Lord of Rajaraja') by its builder, and known locally as Thanjai Periya Kovil ('Thanjavur Big Temple') and Peruvudaiyar Kovil, is a Shaivite Hindu temple built in a Chola architectural style located on the south bank of the Cauvery river in Thanjavur, Tamil Nadu, India.",
      location: {
        pin: 'Bhatkal',
        dist: 'Thanjavur',
        state: 'Tamil Nadu',
        iframe:"https://www.mappls.com/t7ffb7",
      },
      coordinates: {
        x: 10.782778,
        y: 79.131667,
    ...
    photos: {
      cover:
        'https://upload.wikimedia.org/wikipedia/commons/7/7f/Entrance_Brihadeeswara.jpg',
      profile:
        'https://upload.wikimedia.org/wikipedia/commons/7/7f/Entrance_Brihadeeswara.jpg',
    },
    trip:{
      best_time:"November to March",
      nearest_road:"Thanjavur has been conveniently connected to all the important cities.",
      nearest_railway:"The nearest railway station to the Brihadeeswara temple is Tanjore.",
      by_air:"The nearest of all the airports present in the nearby area is, Tiruchirapalli Airport which has been connected by the Indian Airlines and is 58 kms away from the temple. In addition to that, Trichy has also been connected to Chennai and Madurai by Indian Airlines.",
      festivals:"Satabhisag of every month is considered as a festival of ruling stars and is considered as the birth time of Rajaraja. As per the Hindu calendar, in the month of Visaka, celebration at the temple takes place for a period of 9 days. People worship the Deity by bathing them with Champaka fragrant water."
  },
  contact:{
    ...
    gallery: [
      'https://upload.wikimedia.org/wikipedia/commons/d/df/MyTanjoreTripPic19.JPG',
      'https://upload.wikimedia.org/wikipedia/commons/6/60/Brihadeeswarar_Temple_04.jpg',
      'https://upload.wikimedia.org/wikipedia/commons/6/6e/TANJORE_2.jpg',
      'https://upload.wikimedia.org/wikipedia/commons/a/a5/Thanjavur_Brihadeeswara_Temple_Entrance.JPG',
      'https://upload.wikimedia.org/wikipedia/commons/5/51/Brihadeeswara_Temple_Gopuram_at_Night.jpg',
      'https://upload.wikimedia.org/wikipedia/commons/0/01/Big_Temple_Thanjavur.jpg',
      'https://upload.wikimedia.org/wikipedia/commons/0/0a/Thanjavur%2C_Brihadishwara_Temple_%287013915633%29.jpg',
      'https://upload.wikimedia.org/wikipedia/commons/8/8e/Shiva_Nataraja_Tanjore_Bruxelles_02_10_2011_01.jpg',
      'https://upload.wikimedia.org/wikipedia/commons/e/ec/Top_of_Brihadisvara_Temple%2C_Thanjavur.jpg',
      'https://upload.wikimedia.org/wikipedia/commons/a/ac/PeruvudaiyarKoyilThanjavurDancePostition.jpg',
      'https://upload.wikimedia.org/wikipedia/commons/a/a3/N-TN-C192_Nandi_Mandapam_ceiling_with_centuries_old_murals.jpg',
      'https://upload.wikimedia.org/wikipedia/commons/9/9c/Tamil_Inscriptions_in_Thanjavur_Brahadeeshwara_Temple_written_1000_years_ago.jpg',
      'https://upload.wikimedia.org/wikipedia/commons/a/aa/1000_years_Old_Thanjavur_Brihadeeshwara_Temple_View_at_Sunrise.jpg',
      'https://upload.wikimedia.org/wikipedia/commons/a/a4/Brihadisvara_Temple%2C_Thanjavur%2C_Tamil_Nadu%2C_India.jpg',
      'https://upload.wikimedia.org/wikipedia/commons/4/4a/An_elephant_relief_on_the_Brihadisvara_Temple%2C_Thanjavur.jpg',
      'https://upload.wikimedia.org/wikipedia/commons/8/8b/Big_temple_064.jpg',
      'https://upload.wikimedia.org/wikipedia/commons/9/9e/Big_temple_100.jpg',
      'https://upload.wikimedia.org/wikipedia/commons/c/c9/Le_temple_de_Brihadishwara_%28Tanjore%2C_Inde%29_%2813908795928%29.jpg',
      'https://upload.wikimedia.org/wikipedia/commons/e/e7/Chandeshvara_shrine_at_the_Brihadisvara_Temple.jpg',
      'https://upload.wikimedia.org/wikipedia/commons/4/4c/1010_CE_Brihadishwara_Temple%2C_Hindu_god_Shiva%2C_built_by_Rajaraja_I%2C_Thanjavur_Tamil_Nadu_India_%288%29.jpg',
      'https://upload.wikimedia.org/wikipedia/commons/d/df/1010_CE_Brihadishwara_Shiva_Temple%2C_yogini%2C_built_by_Rajaraja_I%2C_Thanjavur_Tamil_Nadu_India.jpg',
      'https://upload.wikimedia.org/wikipedia/commons/6/6e/Tanjore_Paintings_-_Big_temple_01.JPG',
      'https://upload.wikimedia.org/wikipedia/commons/2/25/Big_temple_061.jpg',
      'https://upload.wikimedia.org/wikipedia/commons/2/21/1010_CE_Brihadishwara_Shiva_Temple%2C_wall_relief%2C_built_by_Rajaraja_I%2C_Thanjavur_Tamil_Nadu_India.jpg',
      'https://upload.wikimedia.org/wikipedia/commons/1/1d/Brihadeeswarar_Temple_3407.jpg',
      'https://upload.wikimedia.org/wikipedia/commons/d/df/Nandi_Brihadeeswara.jpg',
      'https://upload.wikimedia.org/wikipedia/commons/3/3a/Sculpture2_Brihadeeswara.jpg',
      'https://upload.wikimedia.org/wikipedia/commons/0/09/Sculpture3_Brihadeeswara.jpg',
      'https://upload.wikimedia.org/wikipedia/commons/d/d6/Relief_Staircase%2C_Brihadeeswara.jpg',
      'https://upload.wikimedia.org/wikipedia/commons/3/30/Relief_detail%2C_Brihadeeswara.jpg',
      'https://upload.wikimedia.org/wikipedia/commons/e/e6/Relief_detail_2_Brihadeeswara.jpg',
      'https://upload.wikimedia.org/wikipedia/commons/7/7f/Entrance_Brihadeeswara.jpg',
      'https://upload.wikimedia.org/wikipedia/commons/f/f7/Thanjavur_Big_Temple_View.jpg',
      'https://upload.wikimedia.org/wikipedia/commons/e/e4/Left_side_view_Brihadeeswara.jpg',
      'https://upload.wikimedia.org/wikipedia/commons/c/c0/PeriyaKoil_June_2016.jpg',
  ...
  },
  {
    basic: {
      name: 'Kailasa Temple',
      bio: "The Kailasha  or Kailashanatha  temple is the largest of the rock-cut Hindu temples at the Ellora Caves near Chhatrapati Sambhaji Maharaj Nagar district of Maharashtra, India.",
      location: {
        pin: 'Ellora Caves',
        dist: 'Shambhaji Nagar District',
        state: 'Maharashtra',
        iframe:"https://www.mappls.com/c3oh2h",
      },
      coordinates: {
        x: 20.023889,
        y: 75.179167,
    ...
    trip:{
      best_time:"June and March",
      nearest_road:"The nearest city to the temple is Kailash temple and is well connected with the temple via road. . Also, the 	Shambhaji Nagar city is properly connected with major cities like Satara, Pune, Nashik, Mumbai, Ahmednagar and Kolhapur.",
      nearest_railway:"The nearest railway station to the temple is the 	Shambhaji Nagar railway station. The distance between the temple and the 	Shambhaji Nagar railway station is around 30kms",
      by_air:" 	Shambhaji Nagar airport is located at around 15 kms from the Kailash temple and is the closest airport to the Kailash temple. The city of Maharashtra in India is very well-connected to the 	Shambhaji Nagar airport.",
      festivals:"No details available"
  },
  contact:{
    address:"Ellora, Verul,Chhatrapati Sambhaji Maharaj Nagar, Maharashtra 431102",
    phone:"Not available"
},
    gallery: [
      'https://upload.wikimedia.org/wikipedia/commons/8/87/Kailasha_temple_at_ellora.JPG',
      'https://upload.wikimedia.org/wikipedia/commons/8/88/Kailasa_temple_overview%2C_Ellora.jpg',
      'https://upload.wikimedia.org/wikipedia/commons/8/8b/Ellora_Caves_-_panoramio_%284%29.jpg',
      'https://upload.wikimedia.org/wikipedia/commons/1/15/Ellora_cave16_001.jpg',
      'https://upload.wikimedia.org/wikipedia/commons/b/b1/The_Kaila%C5%9Ba_temple%2C_Cave_16.jpg',
  ...
  },
  {
    basic: {
      name: 'Kotappakonda',
      bio: "Kotappakonda is a holy hill, situated in Palnadu district, Andhra Pradesh, India. It is located 20 kilometers from Narasaraopet city and 62 kilometers south west of Guntur City.",
      location: {
        pin: 'Kotappakonda',
        dist: 'Palnadu',
    ...
    trip:{
      best_time:"June and March",
      nearest_road:"The temple is located about 20 km from Narasaraopet, and about 45 km from Guntur. The temple is well-connected by road, and there are several bus services that operate to and from the temple. Visitors can also hire taxis or private cars to reach the temple.",
      nearest_railway:"The nearest railway station to the temple is Narasaraopet railway station, which is located about 20 km from the temple. There are several trains that run to and from Narasaraopet, connecting it to major cities like Hyderabad, Chennai, and Bangalore. Visitors can take a taxi or bus from the railway station to reach the temple.",
      by_air:" 	The nearest airport to the temple is the Vijayawada Airport, which is located about 90 km from the temple. The airport is well-connected to major cities in India, including Delhi, Mumbai, Bangalore, and Chennai. Visitors can hire a taxi or take a bus from the airport to reach the temple.",
      festivals:"Maha Shivaratri: This is the most important festival celebrated at the temple, and is dedicated to Lord Shiva. It is celebrated in the month of February or March, and attracts thousands of devotees from all over the country. The festival is marked by the chanting of mantras, the offering of prayers, and the performance of various rituals and ceremonies.Navaratri: This is a nine-day festival celebrated in the months of September or October, and is dedicated to the worship of the divine feminine energy, or Shakti. The festival is marked by the offering of prayers, the lighting of lamps, and the performance of cultural programs and performances.Vinayaka Chaturthi: This festival is dedicated to Lord Ganesha, and is celebrated in the month of August or September. The festival is marked by the installation of idols of Lord Ganesha, the offering of prayers, and the performance of various rituals and ceremonies.Karthika Masam: This is a month-long festival celebrated in the month of November, and is considered a very auspicious time for worship and devotion. The festival is marked by the offering of prayers, the lighting of lamps, and the performance of various rituals and ceremonies."
  },
  contact:{
    address:"Ellora, Verul,Chhatrapati Sambhaji Maharaj Nagar, Maharashtra 431102",
    phone:"Not available"
  ...
  },
  {
    ...
    Architecture: {
      style: 'Chalukya architectural pattern',
  ...
  },
  {
    basic: {
      ...
      bio: "The Kashi Vishwanath Temple is a famous Hindu temple dedicated to Shiva. It is located in Vishwanath Gali, near Varanasi, Uttar Pradesh, India.",
      location: {
        pin: 'Vishwanath Gali',
        dist: 'Varanasi',
        state: 'Uttar Pradesh',
        iframe:"https://www.mappls.com/6f6t46",
      },
      coordinates: {
        x: 25.310775,
        y: 83.010614,
    ...
    Architecture: {
      style: 'Nagara style',
      creator: 'Unknown',
      completed: '1585 CE - by Man Singh I,1780 CE - by Ahilyabai Holkar',
      inscriptions: 'None',
      elevation:1320,
    },
    about: {
      basic_info:
        "   The Kashi Vishwanath Temple is a famous Hindu temple dedicated to Shiva. It is located in Vishwanath Gali, near Varanasi, Uttar Pradesh, India. The temple is one of the most sacred Hindu pilgrimage sites and is among the twelve Jyotirlinga, shrines which are said to be the most sacred abodes of Shiva. Standing on the western banks of the Ganges, the presiding deity is known by the names Shri Vishwanath and Vishweshwara (IAST: Vishveshvara or Vishveshvur), literally meaning Lord of the Universe.Varanasi was called Kashi ('shining') in ancient times, and hence the temple is popularly called Kashi Vishwanath Temple. The temple is considered a central part of worship in Shaiva culture by Hindu scriptures.The temple had been demolished several times, most recently by Mughal emperor Aurangzeb, who constructed the Gyanvapi Mosque on its site. The current structure was built on an adjacent site by the Maratha ruler Ahilyabai Holkar of Indore in 1780.Since 1983, the temple has been managed by a board of trustees set up by the government of Uttar Pradesh.",

      history:
        "As per the Shiva Purana, Brahma (the Hindu God of creation) and Vishnu (the Hindu God of preservation) once had an argument about supremacy. To test their powers, Shiva pierced the three mystical states of the earth as a huge, endless pillar of light, known as a Jyotirlinga. At first, Vishnu incarnated as a boar (Varaha) to dig the earth to search for the base of the pillar, while Brahma, in the form of a swan, searched the sky to find the top of the pillar. Brahma falsely claimed to have found the top of the pillar. However, Vishnu confessed modestly about his failure to locate the base. Shiva cut off Brahma's fifth head as a punishment and cursed Brahma, saying that he would no longer be worshipped. Because Vishnu was honest, he would be worshipped just as much as Shiva and have his own temples for all time.The Manikarnika Ghat is on the bank of the river Ganges. This holy site is very near the Kashi Vishwanath Temple and is named Shakti Pitha, a revered place of worship for the Shaktism sect. The Daksha Yaga, an important Shaivite literature, also mentions the origin of Shakti Peethas.Hindu scriptures describes Vishweshara as the sacred deity of Varanasi, holding the position of king over all the other deities as well as over all the inhabitants of the city and the extended circuit of the Panchkosi, an area (the sacred boundary of Varanasi) spreading over 50 miles.The temple is mentioned in the Puranas including the Kashi Khanda (section) of Skanda Purana (4th-5th century).The original Vishwanath temple, initially known as the Adi Vishveshwara Temple, was destroyed by the Ghurids in 1194, when Mu'izz al-Din Muhammad ibn Sam returned to India and defeated Jayachandra of Kannauj near Chandawar and afterwards razed the city of Kashi. In a few years, the Razia Mosque was constructed in its place. In 1230, the temple was rebuilt near the Avimukteshwara Temple, away from the main site, during the reign of Delhi's Sultan Iltutmish (1211–1266). It was demolished again during the rule of either Hussain Shah Sharqi (1447–1458) or Sikandar Lodi (1489–1517).Raja Man Singh built the temple during Mughal Emperor Akbar's rule. Raja Todar Mal further rebuilt the temple in 1585, but orthodox Brahmins chose to boycott the temple because his daughter was married to Islamic rulers. During the rule of Jahangir, Vir Singh Deo either restored or completed the construction of an earlier temple. In 1669, Mughal Emperor Aurangzeb destroyed the temple and built the Gyanvapi Mosque in its place. The remains of the erstwhile temple can be seen in the foundation, the columns, and at the rear part of the mosque.In 1742, the Maratha ruler Malhar Rao Holkar made a plan to demolish the mosque and reconstruct the Vishweshwar temple at the site. However, his plan did not materialise, partially because of the intervention of the Nawab of Awadh, who was given control of the territory. Around 1750, the Maharaja of Jaipur commissioned a survey of the land around the site, with the objective of purchasing land to rebuild the Kashi Vishwanath temple. However, his plan to rebuild the temple did not materialise either. In 1780, Malhar Rao's daughter-in-law Ahilyabai Holkar rebuilt the present temple adjacent to the mosque.In 1828, Baiza Bai, widow of the Maratha ruler Daulat Rao Scindhia of Gwalior State, built a low-roofed colonnade with over 40 pillars in the Gyan Vapi precinct. During 1833–1840, the boundary of Gyanvapi Well, the ghats and other nearby temples were constructed. Many noble families from various ancestral kingdoms of the Indian subcontinent and their prior establishments make generous contributions for the operations of the temple.In 1835, Maharaja Ranjit Singh of the Sikh Empire, on the behest of his wife, Maharani Datar Kaur, donated 1 tonne of gold for plating the temple's dome. In 1841, Raghuji Bhonsle III of Nagpur donated silver to the temple.The temple was managed by a hereditary group of pandits or mahants. After the death of Mahant Devi Dutt, a dispute arose among his successors. In 1900, his brother-in-law Pandit Visheshwar Dayal Tewari, filed a lawsuit, which resulted in him being declared the head priest.The puja of the Maa Shringar Gauri Temple, on the western side of the disputed Gyanvapi Mosque, was restricted after the demolition of the Babri Masjid in December 1992 due to the ensuing deadly riots that followed the demolition of the mosque. In August 2021, five Hindu women petitioned a local court in Varanasi to be allowed to pray at the Maa Shringar Gauri Temple.Prime Minister Narendra Modi addressing at the inauguration of Kashi Vishwanath Dham on 13 December 2021.In 2019, the Kashi Vishwanath Corridor Project was launched by Narendra Modi to ease access between the temple and the Ganges River, creating a wider space to prevent overcrowding. On 13 December 2021, Modi inaugurated the corridor with a sacred ceremony. A press release by the government said that around 1,400 residents and businesses within the corridor's area were relocated elsewhere and compensated. It also said that more than 40 ruined, centuries-old temples were found and rebuilt, including the Gangeshwar Mahadev temple, the Manokameshwar Mahadev temple, the Jauvinayak temple, and the Shri Kumbha Mahadev temple.In February 2022, the sanctum sanctorum of the temple was gold-plated after an anonymous donor from South India donated 60 kg of gold to the temple. Flowers from the temple are recycled into incense by the biomaterials startup Phool.co.",

      architecture:
        "The temple complex consists of a series of smaller shrines, located in a small lane called the Vishwanatha Galli, near the river. The linga of the main deity at the shrine is 60 centimetres (24 in) tall and 90 centimetres (35 in) in circumference housed in a silver altar. The main temple is quadrangle and is surrounded by shrines of other gods. There are small temples for Kala Bhairava, Kartikeya, Avimukteshwara, Vishnu, Ganesha, Shani, Shiva and Parvati in the complex.There is a small well in the temple called the Jnana Vapi also spelled as Gyan vapi (the wisdom well). The Jnana Vapi well sites to the north of the main temple and during the invasion by the Mughals the Jyotirlinga was hidden in the well to protect it at the time of invasion. It is said that the main priest of the temple jumped in the well with the lingam in order to protect the Jyotirlinga from invaders.There is a Sabha Griha or Congregation Hall leading to the inner Garbha Griha or Sanctum Sanctorum. The venerable Jyotirlinga is a dark brown coloured stone which is enshrined in the Sanctum, placed on a silver platform. Structure of the Mandir is composed of three parts. The first compromises a spire on the temple. The second is gold dome and the third is the gold spire atop the sanctum bearing a flag and a trident.The Kashi Vishwanath temple receives around 3,000 visitors every day. On certain occasions, the numbers reach 1,000,000 and more. Noteworthy about the temple is 15.5-metre-high gold spire and gold Onion dome. There are three domes each made up of pure gold, donated by Maharaja Ranjit Singh in 1835.Ganga Dwara, Gateway of Corridor that connects Kashi Vishwanath Temple with Ghats of Ganges.The Shri Kashi Vishwanath Dham corridor was constructed between Kashi Vishwanath Temple and Manikarnika Ghat along the Ganges River, providing various amenities for pilgrims.Located on the banks of the holy Ganges, Varanasi is regarded among the holiest of the Hindu cities. The Kashi Vishwanath temple is widely recognised as one of the most important places of worship in the Hindu religion. Inside the Kashi Vishwanath Temple is the Jyotirlinga of Shiva, Vishveshvara or Vishvanath. The Vishveshvara Jyotirlinga has a very special and unique significance in the spiritual history of India.Many leading saints, including Adi Sankaracharya, Ramakrishna Paramhansa, Swami Vivekananda, Bamakhyapa, Goswami Tulsidas, Swami Dayananda Saraswati, Sathya Sai Baba, Yogiji Maharaj, Pramukh Swami Maharaj, Mahant Swami Maharaj and Gurunanak have visited the site. A visit to the temple and a bath in the river Ganges is one of many methods believed to lead one on a path to Moksha (liberation). Thus, Hindus from all over the world try to visit the place at least once in their lifetime. There is also a tradition that one should give up at least one desire after a pilgrimage the temple, and the pilgrimage would also include a visit to the temple at Rameswaram in Tamil Nadu in Southern India, where people take water samples of the Ganges to perform prayer at the temple and bring back sand from near that temple. Because of the immense popularity and holiness of Kashi Vishwanath temple, hundreds of temples across India have been built in the same architectural style. Many legends record that the true devotee achieves freedom from death and saṃsāra by the worship of Shiva, Shiva's devotees on death being directly taken to his abode on Mount Kailash by his messengers and not to Yama. The superiority of Shiva and his victory over his own nature—Shiva is himself identified with death—is also stated. There is a popular belief that Shiva himself blows the mantra of salvation into the ears of people who die naturally at the Vishwanath temple.",
    },
    photos: {
      cover:
    ...
    trip:{
      ...
      nearest_road:" Varanasi has a wide and expansive road network, with frequent private and public buses and other road transport services to all major cities and towns in Uttar Pradesh.",
      nearest_railway:"Varanasi city is well connected by railway, and the temple itself is close to a number of railway stations. Varanasi City station is just 2 km away, and Varanasi Junction is around 6 km from the temple.  ",
      by_air:" The closest airport to the temple is the Lal Bahadur Shastri International Airport in Babatpur. From there, the temple is around 25 km or less than an hour by road. There are cabs and buses, private and public, that can take you to the temple straight from the airport.",
      festivals:"Makar Sankranti – According to the solar calendar the sun moves from the Dhanu rashi to the Makar rashi on this day. The period of Uttarayan starts from this day when the sun begins its journey to the northern hemisphere.Basant Panchami – Celebrates the arrival of spring and also Saraswati the goddess of knowledge is worshipped on this day. Maha Shivaratri – This is the great night of Shiva and the most important festival in Varanasi. Here they celebrate this as the night when Shiva married Parvati. A huge wedding procession called Shiva Baraat is taken out in the lanes to the beating of drums and shouts of “Jai Bhole Shankar!” People fast and pray for the day and night. It is also said that on this night Shiva takes the form of Nataraja, the Lord of Dance and dances the tandava.Rangbhari Ekadashi – Lord Vishwanath at the Kashi Vishwanath temple is given a special shringar or decoration.Holi – The festival of colours. This is a bacchanalia with people drinking intoxicants and throwing colours. Visitors are recommended to stay indoors."
  },
  contact:{
    address:"  Vishwanath Gali, Lahori Tola, Varanasi, Uttar Pradesh, 221001",
    phone:"+916393131608,+915422392629"
},
    gallery: [
      'https://upload.wikimedia.org/wikipedia/commons/e/eb/Benares-_The_Golden_Temple%2C_India%2C_ca._1915_%28IMP-CSCNWW33-OS14-66%29.jpg',
    ],
